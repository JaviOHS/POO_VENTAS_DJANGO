# Generated by Django 5.0.6 on 2024-05-30 04:53
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('celular', models.CharField(blank=True, max_length=10, null=True, validators=[django.core.validators.RegexValidator(message='El número de teléfono debe contener entre 9 y 15 dígitos.', regex='^\\d{9,15}$')])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone', models.CharField(max_length=10, unique=True, validators=[django.core.validators.RegexValidator(message='El número de teléfono debe contener entre 9 y 15 dígitos.', regex='^\\d{9,15}$')])),
                ('created', models.DateTimeField(auto_now_add=True)),
                ('updated', models.DateTimeField(auto_now=True)),
                ('state', models.BooleanField(default=True, verbose_name='Estado')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('expiration_date', models.DateTimeField(default=datetime.datetime(2024, 6, 29, 4, 53, 3, 103799, tzinfo=datetime.timezone.utc))),
